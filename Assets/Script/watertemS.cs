...
public class watertemS : MonoBehaviour
{
    ...
    public Toggle toggle, mixsalttoggle;
    ...
    void Start()
    {
        ...
        mixsalttoggle.GetComponent<Toggle>().isOn = false;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            mixsalttoggle.GetComponent<Toggle>().isOn = true;
        }
    }
